...
public class DateUtils {
	...
	/**
	  ...
	  *
	  * @Title: getPreviousOrNextMinutesOfDate
	...
	public static void main(String[] args) {
		Date date = getPreviousOrNextDaysOfNow(43);
		System.out.println(date);
		System.out.println(getBeginDateOfTheWeek(date));
		System.out.println(getEndDateOfTheWeek(date));
		System.out.println(getBeginDateOfTheMonth(date));
		System.out.println(getEndDateOfTheMonth(date));
	}
